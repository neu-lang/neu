...
require_text docs/adr/proposals/reviews/ADR-0028-chief-architect-decision.md 'Decision: request revision before acceptance'
require_text docs/adr/proposals/reviews/ADR-0028-chief-architect-decision.md 'Implementation may not proceed against ADR-0028 until accepted'
