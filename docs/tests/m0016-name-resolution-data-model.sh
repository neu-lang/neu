...
require_text "$source" 'pub struct FunctionReferenceBind'
require_text "$source" 'pub fn bind_unqualified_function_references'
require_text "$source" 'pub struct TypeReferenceBind'
require_text "$source" 'pub fn bind_unqualified_type_references'
require_text "$source" 'pub struct PackageQualifiedTypeReferenceBind'
require_text "$source" 'pub fn bind_package_qualified_type_references'
require_text "$source" 'pub struct AcceptedNameReferenceBind'
require_text "$source" 'pub fn bind_accepted_name_references'
require_text "$source" '^    Immutable,$'
...
require_text "$test_file" 'unqualified_function_reference_binding_uses_same_package_top_level_fallback'
require_text "$test_file" 'unqualified_function_reference_binding_keeps_local_lookup_before_top_level'
require_text "$test_file" 'unqualified_function_reference_binding_rejects_other_package_top_level'
require_text "$test_file" 'unqualified_function_reference_binding_does_not_treat_types_as_function_fallback'
require_text "$test_file" 'unqualified_type_reference_binding_uses_same_package_top_level_fallback'
require_text "$test_file" 'unqualified_type_reference_binding_keeps_local_lookup_before_top_level'
require_text "$test_file" 'unqualified_type_reference_binding_rejects_other_package_top_level'
require_text "$test_file" 'unqualified_type_reference_binding_does_not_treat_functions_as_type_fallback'
require_text "$test_file" 'package_qualified_type_reference_binding_uses_explicit_package_namespace'
require_text "$test_file" 'package_qualified_type_reference_binding_splits_nested_package_at_final_dot'
require_text "$test_file" 'package_qualified_type_reference_binding_ignores_unqualified_type_names'
require_text "$test_file" 'package_qualified_type_reference_binding_rejects_missing_and_function_candidates'
require_text "$test_file" 'accepted_name_reference_binding_combines_expression_and_type_bindings'
require_text "$test_file" 'accepted_name_reference_binding_does_not_duplicate_package_qualified_type_diagnostics'
require_text "$test_file" 'accepted_name_reference_binding_collects_expression_and_type_unresolved_diagnostics'
...
require_text "$parser" 'pub struct ParsedTypeNameReference'
...
require_text "$parser" 'pub type_name_references: Vec<ParsedTypeNameReference>'
...
require_text "$parser_test" 'records_local_immutable_and_var_binding_name_metadata'
...
require_text "$parser_test" 'records_named_type_reference_metadata'
require_text "$parser_test" 'type_name_reference_metadata_records_grouped_and_function_types_in_order'
require_text "$parser_test" 'type_name_reference_metadata_excludes_package_import_expression_and_missing_types'
