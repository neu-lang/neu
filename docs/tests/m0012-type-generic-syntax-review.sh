...
require_text "$review_dir/ADR-0023-chief-architect-decision.md" '^Decision: pending$'
require_text "$review_dir/ADR-0023-chief-architect-decision.md" 'not accepted source of truth'
require_text "$review_dir/ADR-0023-chief-architect-decision.md" 'No acceptance yet'
...
echo "m0012-review: type and generic syntax proposal review validation passed"
