...
require_file crates/compiler/tests/ast.rs
...
require_text crates/compiler/src/lib.rs '^pub mod ast;$'
require_text crates/compiler/src/ast.rs 'pub struct AstNodeId'
require_text crates/compiler/src/ast.rs 'pub enum AstNodeKind'
require_text crates/compiler/src/ast.rs 'SourceFile'
require_text crates/compiler/src/ast.rs 'ByteSpan'
require_text crates/compiler/src/ast.rs 'pub struct AstArena'
require_text crates/compiler/tests/ast.rs 'source_file_root_node_preserves_span'
require_text docs/ast/data-model.md '^# AST Data Model$'
require_text docs/ast/data-model.md 'Status: M0013 expression statement and pattern AST shell'
require_text docs/ast/data-model.md 'The accepted M0009 root node kind is `SourceFile`'
require_text docs/ast/data-model.md 'The accepted M0013 expression, statement, block, and pattern shell node kinds are'
...
require_absent_text crates/compiler/src/ast.rs 'TypeRef|Resolved|Symbol|Borrow|Ownership|FlowFact|Exhaustive|CoroutineFrame|UnsafeBoundary'
