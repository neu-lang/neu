...
- Name-resolution declaration kind: `crates/compiler/src/name_resolution.rs`
...
2026-07-10 main_task=main-task test work phase=verify-tests-fail result=pass notes=cargo test -p compiler --test parser failed before implementation because ParseOutput did not expose declaration_names.
