...
- `crates/newlang/src/types.rs`: `GenericParameterType`, `TypeRecord`, and
  `TypeArena`.
- `crates/newlang/src/parser.rs`: `ParsedGenericParameter`.
- `crates/newlang/src/symbol.rs`: `SymbolInterner`.
- Validation: `cargo test -p newlang --test types m0020_generic_parameter_types`;
