...
- `parsed_surface.neu` uses syntax currently accepted by the frontend parser, including executable-subset arithmetic and bitwise operators whose type checking is intentionally deferred to later M0028 tasks.
