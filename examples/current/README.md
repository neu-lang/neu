...
- `parsed_bootstrap_enum.nl` is accepted by the current parser and records ordered no-payload enum variants. `when` parsing and qualified-arm resolution are available; exhaustiveness checking remains pending M0021 work.
