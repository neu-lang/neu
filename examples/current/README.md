...
- `parsed_surface.neu` uses syntax currently accepted by the frontend parser, including executable-subset arithmetic and bitwise operators. M0028 now has standalone `Int` operator typing for that surface; type-check-core integration remains a later M0028 task.
