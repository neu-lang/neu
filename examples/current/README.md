...
- `parsed_surface.neu` uses syntax currently accepted by the frontend parser, including executable-subset arithmetic and bitwise operators. The M0028 executable type-check core now validates those operators as `Int`; compiler-driver integration and static arithmetic diagnostics remain later work.
