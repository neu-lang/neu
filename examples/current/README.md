...
- `accepted_bootstrap_ownership.nl` shows the accepted ADR-0035 surface for copyable `Int` locals and move-only `String` local transfers. Ownership diagnostics are the next M0022 implementation work.
